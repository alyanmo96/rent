        ...
        <div class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="p-2 text-dark"><a class="nav-link" href="{{ url('admin_edit_tenant_posts') }}">العودة لصفحة الباحثين عن العقارات <span class="sr-only"></span></a></li>
                </ul>
            </div>
        </div> 
        <div class="text-center">
        <form action="/admin_update_tenant_post" method="post" enctype="multipart/form-data">
        @csrf
            @foreach($post as $i)
